 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\SecurityGroupRepository")
 */
class SecurityGroup extends Role
{
    /**
     * @var int
     *
    ...
    /**
     * @ORM\ManyToMany(targetEntity="User", mappedBy="securityGroups")
     */
    private $users;
